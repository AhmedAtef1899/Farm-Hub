...
Widget defaultForm(
    ...
    Builder(
      builder: (context) {
        bool mode = CacheHelper.getData(key: 'iconMode');
        return Container(
          alignment: Alignment.centerLeft,
          height: height,
          decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(radius),
            color: mode? Colors.grey[700] :Colors.white,
          ),
          child: TextFormField(
            decoration: InputDecoration(
              filled: true,
              fillColor: mode? Colors.grey[700] :Colors.white,
              prefixIconColor: mode? CupertinoColors.white :Colors.grey,
              suffixIconColor: mode? Colors.white :Colors.grey,
              labelText: label,
      ...
      return Column(
        ...
        children: [
              ...
              InkWell(
                onTap: () {
                  showModalBottomSheet(
                      backgroundColor: mode?  secondColor : Colors.white,
                      context: context,
                      builder: (context) =>
                  ...
                  children: [
                    Expanded(
                      child: Container(
                        ...
                        height: 44,
                        decoration: BoxDecoration(
                            color: mode?  HexColor("#5E5E65") : Colors.grey[100],
                            borderRadius: BorderRadius.circular(100)),
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
          ...
          listing.authorInfo!.id! == currentUser!.user!.id
              ? const SizedBox()
              : defaultButton(
                  background: mode?  secondColor : Colors.black,
                  text: 'Message',
                  function: () {
                    String roomId =
      ...
      return Column(
        ...
        children: [
                  ...
                  child: Row(
                    children: [
                      Icon(
                        ...
                        color: mode?  Colors.white : Colors.grey[600],
                      ),
                      const SizedBox(
                        width: 5,
                      ),
                      Text(
                        ...
                        style: TextStyle(  color: mode?  Colors.white : Colors.grey[600],),
                      )
                    ],
                  ),
                ),
          ...
          Container(
            ...
            decoration: BoxDecoration(
                color: mode?  HexColor("#39393D") : Colors.white, borderRadius: BorderRadius.circular(100)),
            child: Row(
              children: [
                CircleAvatar(
                  backgroundColor: defaultColor,
                ...
                TextButton(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(100),
                        color: mode?  defaultColor : Colors.grey[100],),
                    child: const Text(
                      'Send',
                      style: TextStyle(
                      ...
                      Expanded(
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            filled: true,
                            fillColor: mode?  HexColor("#54545A") : Colors.grey[200],
                          ),
                        ),
                      ),
                      IconButton(
...
Widget ownerMenu(BuildContext context, Listing listing) => Builder(
  builder: (context) {
    bool mode = CacheHelper.getData(key: 'iconMode');
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Container(
                      color: mode? Colors.grey[900] :Colors.grey[100],
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Container(
                      color: mode? secondColor :Colors.grey[100],
                      padding: const EdgeInsets.all(2),
                      alignment: Alignment.center,
                      child: Row(
                        children: [
